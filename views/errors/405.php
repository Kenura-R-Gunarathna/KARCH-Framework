...
<head>
    <title>Method Not Allowed - <?php print(config('APP_NAME')) ?></title>
    ...
    <section class="bg-white dark:bg-gray-900 flex h-screen">
        <div class="py-8 px-4 max-w-screen-xl lg:py-16 lg:px-6 m-auto">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Method Not Allowed.</p>
                <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, your method is not allowed to proceed. Return to the home page.</p>
