<article class="docs-article">
    ...
    <header class="docs-header">
        ...
        <h1 class="docs-heading">Views, Redirects, Assets <span class="docs-time">Last updated: <?php config('LAST_UPDATED'); ?></span></h1>

        <p>You can control views, redirects and assets in below mentioned methods.</p>
